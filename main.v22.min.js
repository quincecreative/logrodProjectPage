...
for (let i = 0; i < projectThumbnails.length; i++) {
    console.log(projectThumbnails[i].src)
...
//FOR LOCAL DEV
// let coordinates = ["-3.23,0.19,10.19", "-8.71,-0.08,17.01", "21.31,0.49,12.18", "-26.53,0.09,33.74"]

// let projectThumbnailsSrc = ['https://assets-global.website-files.com/65f2ac5c5bdc4db205397c9e/65f831d2989211966d7c4c0f_4.webp',
...
// let projectTitlesNames = ['Fourth Project', 'Third Project', 'Second Project', 'First Project']

// let projectTitlesNamesGer = ['Fourth Project(ger)', 'Third Project(ger)', 'Second Project (ger)', 'First Project(ger)']

// let projectAdresses = ['Adress 4', 'Adress 3', 'Adrees 2', 'Adress 1']

// let projectAdressesGer = ['Adress 4(ger)', 'Adress 3(ger)', 'Adrees 2(ger)', 'Adress 1 (ger)']
...
var createScene = async function () {
    ...
    // //CAMERA
    function cameraTargetAnimation(x, y, z) {
    ...
    //create anotation
    function createAnotationCont(posMesh, imageSrc, proTitle, proAdress) {
        ...
        mainContainer.linkOffsetX = "-175px"
        mainContainer.linkOffsetY = "-75px"
        // mainContainer.alpha = 0;
        mainContainers.push(mainContainer)

        //image container
        var imageContainer = new BABYLON.GUI.Rectangle();
        imageContainer.width = 150 + "px";
        imageContainer.height = 150 + "px";
        ...
        titleContainer.width = 190 + "px";
        titleContainer.height = 30 + "px";
        ...
        titleContainer.top = 20 + "px"
        mainContainer.addControl(titleContainer);
        //title
        var title = new BABYLON.GUI.TextBlock();
        title.color = "Black";
        title.fontSize = 17 + "px"
        title.textHorizontalAlignment = "left"
        title.text = proTitle
        ...
        adress.color = "Gray";
        adress.fontSize = 12 + "px"
        adress.textHorizontalAlignment = "left"
        ...
        buttonContainer.width = 190 + "px";
        buttonContainer.height = 50 + "px";
        buttonContainer.color = "Orange";
        buttonContainer.thickness = 0;
        // buttonContainer.background = "blue";
        buttonContainer.top = 90 + "px"
        ...
        seeDetails.width = "120px"
        seeDetails.height = "40px";
    ...
    function createAnotation(corX, corY, corZ) {
        //fake possition mesh
        ...
        ellipse1.width = 50 + "px"
        ellipse1.height = 50 + "px";
        ellipse1.color = "white";
        ellipse1.thickness = 15;
    ...
    createAnotation(-3.23, 0.19, 10.19)
    ...
    //     createAnotation(coordinatesNum[0], coordinatesNum[1], coordinatesNum[2])
    // }

    // for (let i = 0; i < coordinates.length; i++) {
    //     createAnotationCont(posMeshes[i], projectThumbnailsSrc[i], projectTitlesNames[i], projectAdresses[i])
    ...
    //     if (annotationOpened) {
    //         // console.log(i)
    //         ellipses1[i].thickness = 5;
    //         ellipses1[i].width = 70 + "px"
    //         ellipses1[i].height = 70 + "px";

    //         ellipses2[i].width = 30 + "px"
    //         ellipses2[i].height = 30 + "px";

    //         mainContainers[i].width = 350 + 'px'
    //         mainContainers[i].height = 150 + 'px'
    //     } else {
    ...
    //             //mainAlpha += 0.2
    //             if (mainWidth < 351 || mainHeight < 151) {
    ...
    //     // console.log(i)
    //     ellipses1[i].thickness = 15;
    //     ellipses1[i].width = 50 + "px"
    //     ellipses1[i].height = 50 + "px";
    ...
    //         if (!devMode) {
    //             cameraTargetAnimation(coordinatesForDirectons[i][0], coordinatesForDirectons[i][1], coordinatesForDirectons[i][2])
    //         }
    //     });
    // }
    // // let mainContEntered = false
